# @Time : 2023/11/18 15:02
# @Author : Cheng Yang
# @File ：process_data_v1.py
    ...
    for dataset_name in dataset_name_list:
        for dataset_type in dataset_type_list:  # 对每个文件
            ...
            for doc in dataset:  # 对每个文档
                ...
                forward_query_list.append(["Is an emotional subordinate clause describing the emotion of an event ?"])
                backward_query_list.append(["Is a causal subordinate clause describing the cause of an event ?"])
                ...
                for pair in doc_couples:  # 注意，一个情感子句可能对应多个原因子句，所以会有[[10, 8], [10,9]]的情况
                    ...
                    if emotion_idx not in temp_emotion:
                        ...
                        for e, c in doc_couples:
                            if e == emotion_idx:
                                causes.append(c)
                        query_f = clause_list[
                                      emotion_idx - 1] + 'The corresponding causal clauses for this sentence are?'
                    ...
                    query_b = clause_list[
                                  cause_idx - 1] + 'Which sentence is the emotional clause corresponding to this sentence?'
