# @Time : 2023/11/18 15:03
# @Author : Cheng Yang
# @File ：preprocess_tokenized_data_v1.py
...
sys.path.append('/home/ubuntu/workspace1/rmj/ECPE/ecpe_extractor/artifacts/longformer')
...
def pre_processing(sample_list, max_len_dict):
    tokenizer = AutoTokenizer.from_pretrained("/home/ubuntu/workspace1/rmj/ECPE/ecpe_extractor/artifacts/longformer")
    _docid_list = []
    _clause_list = []
    _doc_len_list = []
    _clause_len_list = []
